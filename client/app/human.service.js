...
var HumanService = (function () {
    ...
    HumanService.prototype.getHumans = function () {
        return this.http.get('/api/humans').map(function (response) { return response.json(); });
    };
    HumanService.prototype.deleteHuman = function (id) {
        return this.http.delete('/api/human/' + id).map(function (response) { return response.json(); });
    };
    HumanService.prototype.modifyHuman = function (id, human) {
        var headers = this.setHeader({ 'Content-Type': 'application/json' });
        return this.http.post('/api/human/' + id, JSON.stringify(human), { headers: headers })
            .map(function (response) { return response.json(); });
    };
    HumanService.prototype.setHeader = function (options) {
